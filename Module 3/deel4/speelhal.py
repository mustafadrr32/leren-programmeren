...
vr_vip_ordered = input_yes_no('Wilt u VR-VIP seats?(J/N)') in ("J", "j")
...
if vat_invoice:
    ...
    total_cola_vat = get_vat_from_amount_incl(total_cola, VAT_CODE_L)
    total_popcorn_vat = get_vat_from_amount_incl(total_popcorn, VAT_CODE_L)
    total_vat_H = total_tickets_vat + total_vr_vip_seats_vat
    total_vat_L = total_cola_vat + total_popcorn_vat
